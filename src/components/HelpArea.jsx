...
const HELP_ITEMS = [
  ...
  },
  {
    ...
    text: 'GitHub Actions is an automation service (or CI / CD service) offered by the company Github, that helps you automate repository-related workflows and processes.',
  },
];
